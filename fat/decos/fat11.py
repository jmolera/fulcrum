...
#Creación del csv de fijos
with open('fijos_fat.csv', 'w') as csvfile:
...
with open('variables_fat.csv', 'w') as csvfile:
    writer = csv.writer(csvfile, delimiter=",")
...
for index, row in fulcrum_csv_data.iterrows():
	...
	#*******************************************************************
	#Paths imágenes
	path_photos = r'/Users/jmpas/Desktop/sat/photos_fat_decos/'
